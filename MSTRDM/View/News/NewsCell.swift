...
class NewsCell: BaseCell {
    ...
    override init(frame: CGRect) {
        ...
        shadowLabel(shadowOpacity: 0.5,
                    shadowOffset: .init(width: 0,
                                        height: 0),
                    shadowRadius: 5, to: titleLabel)
        
        shadowLabel(shadowOpacity: 0.5,
                    shadowOffset: .init(width: 0,
                                        height: 0),
                    shadowRadius: 5, to: desctiptionLabel)
    ...
    private func setupUI() {
        ...
        stackBlackView.fillSuperview(padding: .init(top: 0,
                                                    left: 0,
                                                    bottom: 0,
                                                    right: 0))
        
        stackView.fillSuperview(padding: .init(top: 0,
                                               left: 16,
                                               bottom: 0,
                                               right: 16))
        
        dateLabel.anchor(top: imageView.topAnchor,
        ...
        desctiptionLabel.anchor(top: titleLabel.bottomAnchor,
                                leading: imageView.leadingAnchor,
    ...
    private func shadowLabel(shadowOpacity: Float, shadowOffset: CGSize, shadowRadius: CGFloat, to labelText: UILabel) {
